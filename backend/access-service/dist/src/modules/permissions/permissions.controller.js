...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Назначить право доступа ресурсу (RBAC)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Получить все права доступа пользователя (включая через роли)' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Структура доступа пользователя (дома, комнаты, устройства, функции)' }),

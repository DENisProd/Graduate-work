...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'ID субъекта (например externalUserId или memberId)' }),
    __metadata("design:type", String)
], AuditLogResponseDto.prototype, "actorId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Тип действия: ROLE_CREATED, MEMBER_ADDED, ACCESS_GRANTED, POLICY_CREATED и др.' }),
    __metadata("design:type", String)

...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: client_1.ResourceType, description: 'Тип ресурса (ROOM, DEVICE, DEVICE_FUNCTION, ...)' }),
    (0, class_validator_1.IsEnum)(client_1.ResourceType),
    __metadata("design:type", String)
], CreateResourceDto.prototype, "type", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ format: 'uuid', description: 'ID родительского ресурса' }),
...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateResourceDto.prototype, "externalId", void 0);

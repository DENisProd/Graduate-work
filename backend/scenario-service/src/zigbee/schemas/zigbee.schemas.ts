...
export type UpsertZigbeeDeviceInput = z.infer<
  typeof upsertZigbeeDeviceSchema
>;
...
export const listZigbeeLinksQuerySchema =
  listZigbeeLinksQuerySchemaBase.merge(zigbeeLinksPaginationSchema);

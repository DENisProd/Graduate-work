...
const integration_catalog_controller_1 = require("./integration-catalog.controller");
...
exports.IntegrationModule = IntegrationModule = __decorate([
    (0, common_1.Module)({
        controllers: [integration_catalog_controller_1.IntegrationCatalogController],
        providers: [integration_catalog_service_1.IntegrationCatalogService],
    })
], IntegrationModule);

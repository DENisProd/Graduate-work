...
async function bootstrap() {
    ...
    const config = new swagger_1.DocumentBuilder()
        ...
        '',
        'Публичные маршруты — только чтение и мягкое удаление; префикс **/api/v1/admin/** — полный CRUD; **/api/v1/integration/** — вызовы для межсервисной интеграции (например ensure каталога).',
    ].join('\n'))
        .setVersion('1.0')

    ...
    schema: {
      ...
      properties: {
        ...
        deviceId: {
          type: 'number',
          minimum: 1,
          description: 'ID абстрактного устройства из device-service',
        },
        deviceCategoryId: {
          type: 'number',
          minimum: 1,
          description: 'ID абстрактной категории устройства из device-service',
        },
  ...
  @ApiBody({
    schema: {
      ...
      properties: {
        ...
        deviceId: { type: 'number', minimum: 1, nullable: true },
        deviceCategoryId: { type: 'number', minimum: 1, nullable: true },

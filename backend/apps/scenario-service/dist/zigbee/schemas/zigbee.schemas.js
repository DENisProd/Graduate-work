...
const listZigbeeDeviceLogsQuerySchemaBase = zod_1.z.object({
    ...
    from: zod_1.z.coerce.date().optional(),
    to: zod_1.z.coerce.date().optional(),
    kind: exports.zigbeeDeviceLogKindSchema.optional(),
    source: exports.zigbeeDeviceLogSourceSchema.optional(),
});
exports.listZigbeeDeviceLogsQuerySchema = listZigbeeDeviceLogsQuerySchemaBase.merge(pagination_1.paginationQuerySchema.extend({
    limit: zod_1.z
        .preprocess((v) => (v === '' || v === null || v === undefined ? undefined : v), zod_1.z.coerce.number().int().min(1).max(100).optional())
        .default(50),
}));
exports.zigbeeSocketSubscribeSchema = zod_1.z
    .object({
    deviceIeeeAddrs: zod_1.z.array(zod_1.z.string().min(3).max(64)).max(200).optional(),
    physicalDeviceIds: zod_1.z.array(zod_1.z.string().min(24).max(24)).max(200).optional(),
})
